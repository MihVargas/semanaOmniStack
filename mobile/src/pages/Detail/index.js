    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                <Text style={[styles.insidentProperty, { marginTop: 0 }]}>ONG:</Text>
                <Text style={styles.insidentValue}>{incident.name} de {incident.city}/{incident.uf}</Text>

                <Text style={styles.insidentProperty}>CASO:</Text>
                <Text style={styles.insidentValue}>{incident.description}</Text>

                <Text style={styles.insidentProperty}>VALOR:</Text>
                <Text style={styles.insidentValue}>{valor}</Text>
            </View>
